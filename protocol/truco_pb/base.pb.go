...
const (
	...
	Uri_PktGameSetPointRsp     Uri = 18
	Uri_PktGameSetCardsRsp     Uri = 19
	// client to server
...
var Uri_name = map[int32]string{
	...
	18:   "PktGameSetPointRsp",
	19:   "PktGameSetCardsRsp",
...
var Uri_value = map[string]int32{
	...
	"PktGameSetPointRsp":     18,
	"PktGameSetCardsRsp":     19,
...
type GameStartRsp struct {
	...
	ReconnTimeout        int32    `protobuf:"varint,2,opt,name=reconnTimeout,proto3" json:"reconnTimeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GameStartRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GameStartRsp.Merge(m, src)
}
...
func (m *GameStartRsp) GetCountDown() int32 {
	if m != nil {
		return m.CountDown
	}
	return 0
...
func (m *GameStartRsp) GetReconnTimeout() int32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*GameStartRsp)(nil), "pbtruco.GameStartRsp")
...
var fileDescriptor_db1b6b0986796150 = []byte{
	...
	,
}
...
func (m *GameStartRsp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GameStartRsp) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.CountDown != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintBase(dAtA, i, uint64(m.CountDown))
	}
	if m.ReconnTimeout != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintBase(dAtA, i, uint64(m.ReconnTimeout))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *GameStartRsp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CountDown != 0 {
		n += 1 + sovBase(uint64(m.CountDown))
	}
	if m.ReconnTimeout != 0 {
		n += 1 + sovBase(uint64(m.ReconnTimeout))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *GameStartRsp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GameStartRsp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GameStartRsp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReconnTimeout", wireType)
			}
			m.ReconnTimeout = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReconnTimeout |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
